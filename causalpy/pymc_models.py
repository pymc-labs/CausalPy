    ...
    **Pass centred** ``dbar_unit`` **and** ``dbar_time``. Subtracting their means
    ...
    def build_model(  # type: ignore[override]
        ...
        *,
        ...
        with self:
            ...
            # (obs_ind, treated_units) convention that predict/score/calculate_impact
            # rely on. See BayesianBasisExpansionTimeSeries.build_model.
            mu = pm.Deterministic(
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        ``["obs_ind", "treated_units"]``, :meth:`PyMCModel.score` and
        :meth:`PyMCModel.calculate_impact` work unchanged.
