...
def draw_figure(plot: Any, title: str, figsize: tuple[float, float]) -> Figure:
    ...
    # plotnine composes panels with its own layout engine, which ignores subplots_adjust, so the suptitle goes above the figure box and the tight bounding box used by savefig and the notebook backend grows to include it.
