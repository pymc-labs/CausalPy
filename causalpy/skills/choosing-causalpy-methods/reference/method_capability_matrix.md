...
| `StaggeredDifferenceInDifferences` | Long unit-time panel with different treatment times | Bayesian and sklearn/OLS | `summary()`, `effect_summary()`, `plot()` | Treatment must be absorbing. |
