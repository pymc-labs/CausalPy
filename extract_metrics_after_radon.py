...
cc_data  = rodar_radon(["radon", "cc",  "causalpy", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "causalpy", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "causalpy", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "causalpy", "-j"])
