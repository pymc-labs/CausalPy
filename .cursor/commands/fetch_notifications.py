...
def fetch_notifications(days=7):
    ...
    print(f"📡 Fetching notifications since {since_date}...")
    ...
    print(f"📬 Found {len(notifications)} CausalPy notifications")
...
def main():
    ...
    print("🔍 Enriching notifications with details...")
    enriched = []
    ...
    print(f"\n✅ Saved {len(enriched)} enriched notifications to {output_file}")
    print("\n📊 Summary by category:")
