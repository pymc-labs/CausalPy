...
myst:
  html_meta:
    description: "Example gallery of causal inference methods in Python: synthetic control, difference-in-differences, interrupted time series, regression discontinuity, instrumental variables, and inverse propensity weighting with CausalPy."
"og:description": "Example gallery of causal inference methods in Python: synthetic control, difference-in-differences, interrupted time series, regression discontinuity, instrumental variables, and inverse propensity weighting with CausalPy."
---
...
:::{grid-item-card} Staggered Difference-in-Differences with `pymc` models
:class-card: sd-card-h-100
...
:::{grid-item-card} Event Study (Dynamic Difference-in-Differences)
:class-card: sd-card-h-100
:img-top: ../_static/thumbnails/event-study-pymc.png
:link: event-study-pymc
:link-type: doc
:::
::::
...
:::{grid-item-card} Interrupted Time Series (ITS) with `pymc` models
:class-card: sd-card-h-100
