...
:::{grid-item-card} Bayesian Synthetic Control in Python
:class-card: sd-card-h-100
...
:::{grid-item-card} Staggered Difference-in-Differences (DiD) in Python
:class-card: sd-card-h-100
...
:::{grid-item-card} Bayesian Interrupted Time Series (ITS) Analysis in Python
:class-card: sd-card-h-100
...
:::{grid-item-card} Inverse Propensity Score Weighting (IPW) in Python
:class-card: sd-card-h-100
